...
export const SECTION_META_BY_KEY: Record<string, { display: string; icon?: string }> = {
    allergies: { display: "Allergies", icon: "allergies" },
    care_plan: { display: "Care Plan", icon: "health-worker-form" },
    chief_complaint: { display: "Chief Complaint", icon: "megaphone" },
    encounters: { display: "Encounters", icon: "ambulatory-clinic" },
    functional_statuses: { display: "Functional Status", icon: "wheelchair" },
    immunizations: { display: "Immunizations", icon: "syringe-vaccine" },
    instructions: { display: "Patient Instructions", icon: "doctor" },
    medications: { display: "Medications", icon: "medicine-bottle" },
    problems: { display: "Problems", icon: "alert-triangle" },
    procedures: { display: "Procedures", icon: "general-surgery" },
    results: { display: "Results", icon: "test-tubes" },
    smoking_status: { display: "Smoking Status", icon: "smoking" },
    vitals: { display: "Vitals", icon: "cardiogram" },
    advance_directives: { display: "Advance Directives" },
    family_history: { display: "Family History", icon: "people" },
    medical_equipment: { display: "Medical Equipment", icon: "stethoscope" },
    social_history: { display: "Social History", icon: "group-discussion-meeting" },
    payers: { display: "Payers", icon: "insurance-card" },
    goals: { display: "Goals" },
